...
ui <- function(request) {
  dashboardPage(skin = 'black',
    ...
    dashboardHeader(title = "Welcome to M-DIVE", titleWidth = 350),
    ...
    dashboardSidebar(
      sidebarMenu(
        ...
        div(class = 'sidebar-menu', id = "sidebar_nav",
            ...
            menuItem("M-DIVE Reports", tabName = "reports", selected = TRUE),
            menuItem("Data Catalog",   tabName = "overview")
        ),
        ...
        tabItem(tabName = 'home',
          ...
          fluidRow(shinydashboard::box(
            ...
            title = span(icon("chart-line", lib = "font-awesome"),
                         actionLink('reports_go', ' M-DIVE Reports',
          ...
          fluidRow(shinydashboard::box(
            ...
            title = span(icon("database", lib = "font-awesome"),
                         actionLink('data_go', ' Data Catalog',
                                    style = 'text-decoration:underline')),
            width = 12, closable = FALSE, collapsible = TRUE,
            solidHeader = TRUE, collapsed = TRUE,
